'''almost seems to work -- doesn't load html page though.
borrowed from https://defn.io/2018/02/25/web-app-from-scratch-01/
'''
    ...
    try:
        with open(abspath, "rb") as f:
            ...
            if content_type is None:
                content_type = "applicatkon/octet-stream"
...
def iter_lines(sock: socket.socket, bufsize: int=16_384) -> typing.Generator[bytes, None, bytes]:
    """Given a socket, read all the individual (RLF-separated lines
